...
\begin{figure}[htbp]
    \centering
    \input{handbook/figures/figure3.tex}
...
Un uso preciso della terminologia è essenziale per un coinvolgimento critico con la letteratura sull'IA. Le seguenti definizioni vengono utilizzate in modo coerente in tutto questo manuale:
...
\begin{itemize}
    ...
    \item Un'immagine di vetrino intero colorata con Ki-67 digitalizzata scaricabile a \href{https://openslide.cs.cmu.edu/download/openslide-testdata/Hamamatsu/OS-2.ndpi}{questo link} (931.42 MB).
\end{itemize}
...
\begin{figure}[htbp]
  \centering
  \input{handbook/figures/mindMap_chapter3.tex}
  \label{fig:mindmap_ch3}
\end{figure}